...
IN_JSON = os.path.join(BASE, "oregon_critters_filtered_20k_animal.json")
OUT_JSON = os.path.join(BASE, "oregon_critters_filtered_20k_animal_yolo.json")
...
# Remap string image ids (here, the original nested S3 path) -> sequential ints, preserve
